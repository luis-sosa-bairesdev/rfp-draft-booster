"""
Complete tests for prompt templates.
"""
...
class TestPromptTemplatesComplete:
    """Complete tests for prompt template functions."""
    ...
    def test_get_extraction_prompt_with_page(self):
        ...
        assert "page 5" in prompt.lower() or "5" in prompt
